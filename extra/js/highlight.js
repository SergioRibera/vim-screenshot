...
hljs.registerLanguage('javascript', function () {
  ...
  */
  ...
  function javascript(hljs) {
     ...
     */
    var hasClosingTag = function hasClosingTag(match, _ref10) {
      var after = _ref10.after;
...
hljs.registerLanguage('typescript', function () {
  ...
  */
  ...
  function javascript(hljs) {
     ...
     * @param {{after:number}} param1
     */
    var hasClosingTag = function hasClosingTag(match, _ref12) {
